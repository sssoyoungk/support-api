...
{
    [SupportsAuth]
    [Route("api/StrategyBusiness/ManageSamsungFireGenoPac")]
    public class ManageSamsungFireGenoPacController : ApiController
    {
        /// <summary>
        /// 조회
        /// </summary>
        ...
        public IHttpActionResult Get(DateTime beginDate, DateTime endDate)
        {
            ...
            {
                string sql;
                sql = $"SELECT CONVERT(varchar, ppi.RegistDateTime, 23) AS RegistDate, CONVERT(varchar, ppi.CompOrderDate, 23) AS CompOrderDate, ppi.CompOrderNo\r\n" +
                      ...
                      $"and ppi.CompCode = ltcoi.CompCode\r\n" +    //박상준 추가(2021-10-22) : 교보생명과 겹쳐 의뢰일과 의뢰번호가 같으면 2행씩 조회됨.
        ...
        /// <returns></returns>
        [Route("api/StrategyBusiness/ManageSamsungFireGenoPac/TestCount")]
        public IHttpActionResult GetTestCount(int year = 0, int week = 0)
        {
            try
            {
                ...
                sql = $"SELECT TOP 1 DATEPART(YEAR, ptc.BeginDate) AS Year, DATEPART(WEEK, ptc.BeginDate) AS Week\r\n" +
                      ...
                      $"WHERE CustomerCode = 'samsungfire'\r\n";
                if (week == 0)
                {
        ...
        /// </summary>
        /// <returns></returns>
        [Route("api/StrategyBusiness/ManageSamsungFireGenoPac/RCInfo")]
        public IHttpActionResult GetRCInfo()
        {
            try
            {
                ...
                sql = $"SELECT pce.EmpCode, pce.EmpName, pce.Password, pce.CompSubCode\r\n" +
                      ...
                      $"WHERE pce.CustomerCode = 'samsungfire'\r\n" +
        ...
        [Route("api/StrategyBusiness/ManageSamsungFireGenoPac/CompSubCode")]
        ...
        #region 방문 병원 관리
        [Route("api/StrategyBusiness/ManageSamsungFireGenoPac/CompList")]
        public IHttpActionResult GetCompList()
        {
            ...
            sql = "SELECT pl.CompCode, pcc.CompName, pl.State, pl.City, pl.Town, IsUse\r\n" +
                  ...
                  "WHERE pl.CustomerCode = 'samsungfire'";
